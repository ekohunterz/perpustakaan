...
<head>
    ...
    <title>Perpustakaan {{ $setting->nama_sekolah }}</title>

    <link type="image/x-icon" href="{{ asset('img/svg/favicon.svg') }}" rel="shortcut icon" />
    <link type="image/png"
        ...
        rel="shortcut icon" />
    @vite(['resources/assets/compiled/css/app.css', 'resources/assets/compiled/css/app-dark.css'])
...
<body>
    ...
    <div>
        <div class="layout-horizontal" id="auth">
            <header>
                    ...
                    <div class="container" style="margin-right: 1.5rem">
                        <div class="d-flex justify-content-end">
                            <ul>
                                ...
                                <li class="menu-item {{ Request::is('pengunjung') ? 'active' : '' }}">
                                ...
                                @auth
                                    <li class="menu-item">
                                        <form action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button class="menu-link text-decoration-none border-0" style="background: rgba(0,0,0,0)">
                                                <span>Logout</span>
                                            </button>
                                        </form>
                                    </li>
