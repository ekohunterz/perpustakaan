...
class HistoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                return '<button class="btn btn-sm btn-primary action" data-id="' . $row->id . '" type="button"><i class="bi bi-eye"></i></button>';
            })
            ->rawColumns(['kondisi_buku_saat_dipinjam', 'kondisi_buku_saat_dikembalikan', 'status', 'foto_buku', 'action'])
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('member_id')->title('Nama Member'),
